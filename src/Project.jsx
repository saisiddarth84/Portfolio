...
import foodieImage from "./assests/foodieHome.webp"
                ...
                <div className="details w-full text-white font-Poppins px-4 py-2 md:px-8 md:py-8 flex flex-col gap-6 relative">
                  ...
                  <div className="project-links">
                    <div className="md:mt-6 mb-3 flex justify-end gap-10 items-center">
                      <a
                        href="https://github.com/saisiddarth84/Streamy"
              ...
              >
                ...
                <div className="details w-full text-white font-Poppins  px-4 py-2 md:px-8 md:py-8 flex flex-col gap-6 relative">
                  ...
                  <div className="project-links">
                    <div className="md:mt-6 mb-3 flex justify-end gap-10 items-center">
                      <a
                        href="https://github.com/saisiddarth84/Foodie-app"
                        className="hover:-translate-y-1 transition-all z-[3]"
                        target="_blank"
                        rel="noreferrer"
                        cursor="pointer"
                      ...
                      <a
                        href="https://myfoodiestore.netlify.app/"
                        className="hover:-translate-y-1 transition-all z-[3]"
                        target="_blank"
                        rel="noreferrer"
                        cursor="pointer"
