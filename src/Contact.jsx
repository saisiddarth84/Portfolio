        ...
        <div className="contact-wrapper flex flex-col justify-start items-center  h-full  gap-40">
          <div className="contact-details w-full  lg:w-3/5 flex-col justify-center items-center pl-4">
            ...
            <p className="text-white font-Poppins text-sm md:text-base lg:tracking-wide whitespace-break-spaces">
              ...
              <a
                href="mailto:saisiddarthaj282@gmail.com"
                className="hover:underline text-pink-500"
              >
                saisiddarthaj282@gmail.com
              </a>{" "}
          ...
          >
            <button>
              <a
                href="https://github.com/saisiddarth84"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <button>
              <a
                href="https://www.linkedin.com/in/sai-siddarth-a-j-16bb0b283?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <button>
              <a
                href="https://twitter.com/SaiSiddart64119"
                target="_blank"
                rel="noreferrer"
              >
                <svg
